		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#eduapbezsd042materiallist2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eduapbezsd042materiallist2-display": {
								"semanticObject": "eduapbezsd042materiallist2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=edu.ap.be.zsd042materiallist2",
									"url": sap.ui.require.toUrl("edu/ap/be/zsd042materiallist2")
								}
							}
						}
					}
