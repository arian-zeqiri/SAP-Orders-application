sap.ui.define([
    ...
    return BaseController.extend("edu.ap.be.zsd042materiallist2.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "edu.ap.be.zsd042materiallist2.view.ViewSettingsDialog",
                    controller: this
        ...
        onPressAddOrder: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("CreateOrder")
            }, bReplace);*/
        },
